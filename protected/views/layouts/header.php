...
<html lang="en"><!-- InstanceBegin template="/Templates/index.dwt" codeOutsideHTMLIsLocked="false" -->
    ...
    <body data-spy="scroll" data-target=".bs-docs-sidebar">
                    ...
                    <div class="navbar no_margin">
                        <div class="navbar-inner navbar-inner_main row-fluid">
                            <a href="<?= Yii::app()->request->getBaseUrl(true) ?>/home" class="span4">
                                ...
                                <img src="<?= Yii::app()->request->getBaseUrl(true) ?>/img/white-logo.png" width="175" class="margintop25">
                            </a>
        ...
        if (Yii::app()->user->hasFlash('success')) {
            echo '<h4 class="alert alert-danger span5 offset4 text-center">' . Yii::app()->user->getFlash('success') . ' <a class="close pull-right" data-dismiss="alert" href="#">&times;</a></h4>';
        }
        ?>