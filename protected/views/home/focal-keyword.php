                        ...
                        <div class="no_margin login_sys pull-right text-center minheight300">
                            <div class="myrow">
                                <div class="span12 color_div login-box">
                                    <h2 class="green font20">Enter Your Forex Focal Keywords<br><b class="font14">(or just click "Proceed")</b></h2>
                                    <form action="<?= Yii::app()->request->getBaseUrl(true) ?>/home/chooseKeyword" method="post" class="margintop20 dis_tab100">
                                        <div class="span7 offset3">
                                            <div class="pull-left">
                                                <input type="text" name="keyword[]" id="other-text" style="width: 300px;" value="<?= Yii::app()->user->hasState('keyword') ? Yii::app()->user->getState('keyword') : '' ?>">
                                                <br>
                                                <span class="font12">(feel free to use connectors, e.g. "Euro" and "Easing")</span>
                                            </div>
                                            <input type="submit" class="btn btn-success btn-large pull-left" value="Proceed" style="margin-left: 10px;">
                                        </div>
                                    </form>
                                    <div class="row-fluid margintop30">
                                        <h4 class="green underline text-left">Example focal keywords:</h4>
                                        <?php
                                        if ($model) {
