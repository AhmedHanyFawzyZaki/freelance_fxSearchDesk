...
class PHPCrawlerHTTPRequest
{
  ...
  {
    // Init LinkFinder
    if (!class_exists("PHPCrawlerLinkFinder",false)) include_once(dirname(__FILE__)."/PHPCrawlerLinkFinder.class.php");
    $this->LinkFinder = new PHPCrawlerLinkFinder();
    
    // Init DNS-cache
    if (!class_exists("PHPCrawlerDNSCache",false)) include_once(dirname(__FILE__)."/PHPCrawlerDNSCache.class.php");
    $this->DNSCache = new PHPCrawlerDNSCache();
    
    // Cookie-Descriptor
    if (!class_exists("PHPCrawlerCookieDescriptor",false)) include_once(dirname(__FILE__)."/PHPCrawlerCookieDescriptor.class.php");
    
    // ResponseHeader-class
    if (!class_exists("PHPCrawlerResponseHeader",false)) include_once(dirname(__FILE__)."/PHPCrawlerResponseHeader.class.php");
    
    // PHPCrawlerHTTPProtocols-class
    if (!class_exists("PHPCrawlerHTTPProtocols",false)) include_once(dirname(__FILE__)."/Enums/PHPCrawlerHTTPProtocols.class.php");
  }
