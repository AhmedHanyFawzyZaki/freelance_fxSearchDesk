...
class PHPCrawlerLinkFinder
{
  ...
  public function __construct()
  {
    ...
    if (!class_exists("PHPCrawlerMemoryURLCache",false)) include_once(dirname(__FILE__)."/UrlCache/PHPCrawlerMemoryURLCache.class.php");
    ...
    if (!class_exists("PHPCrawlerLinkSearchDocumentSections",false)) include_once(dirname(__FILE__)."/Enums/PHPCrawlerLinkSearchDocumentSections.class.php");
  }
